...
src/objects.p8 TILES1.BIN TILES1.PAL TILES2.BIN TILES2.PAL TITLESCREEN.BIN TITLESCREEN.PAL FONT.BIN BGSPRITE.BIN BGSPRITE.PAL LOGOSPRITE.BIN: src/convert_images.py images-classic/catalog.ini images-new/catalog.ini
	@$(PYTHON) src/convert_images.py

ROCKRUNNER.PRG: src/*.p8 src/objects.p8 TILES1.BIN TILES1.PAL TILES2.BIN TILES2.PAL TITLESCREEN.BIN TITLESCREEN.PAL FONT.BIN BGSPRITE.BIN BGSPRITE.PAL LOGOSPRITE.BIN
	$(PROG8C) src/rockrunner.p8 -target cx16
	@mv rockrunner.prg ROCKRUNNER.PRG

zip: all
	rm -f rockrunner.zip
	$(ZIP) -r rockrunner.zip ROCKRUNNER.PRG TILES1.BIN TILES1.PAL TILES2.BIN TILES2.PAL TITLESCREEN.BIN TITLESCREEN.PAL FONT.BIN BGSPRITE.BIN BGSPRITE.PAL LOGOSPRITE.BIN CAVES HISCORES/README.TXT manifest.json
