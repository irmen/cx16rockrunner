...
zip: all
	rm -f rockrunner.zip
	$(ZIP) rockrunner.zip ROCKRUNNER.PRG TILES.BIN TILES.PAL TITLESCREEN.BIN TITLESCREEN.PAL FONT.BIN BGSPRITE.BIN BGSPRITE.PAL LOGOSPRITE.BIN CAVES HISCORES manifest.json
