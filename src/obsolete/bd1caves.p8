bd1caves {
    ...
    sub initial_attributes(ubyte id) -> ubyte {
        when id {
            $08, $31 -> return cave.ATTR_MOVING_LEFT            ; firefly0 + butterfly1
            $09, $32 -> return cave.ATTR_MOVING_UP              ; firefly1 + butterfly2
            $0a, $33 -> return cave.ATTR_MOVING_RIGHT           ; firefly2 + butterfly3
            $0b, $30 -> return cave.ATTR_MOVING_DOWN            ; firefly3 + butterfly0
            else -> return 0
        }
    }
